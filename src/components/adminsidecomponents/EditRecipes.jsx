    ...
    return (
        <div className="admin-card" fluid>
            ...
            <Form className="admin-form">
                ...
                <Button className="admin-form__button" variant="primary" onClick={() => updateRecipebyId(id, {rcat_id, recipe_name, prep_time, cooking_time, recipe_desc, recipe_img, recipe_step, admin_name, visibility, visibility_start_date, visibility_end_date}).then(window.location.href = "http://localhost:3000/managerecipes")}>
                    Submit
                </Button>
            </Form>
        </div>
